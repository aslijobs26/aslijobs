      ...
      <SettingsSection
        ...
        action={
          <Link
            ...
            className="inline-flex min-h-8 items-center justify-center rounded-lg border border-border-subtle px-2.5 text-xs font-semibold text-foreground transition-colors hover:bg-primary-light/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 sm:min-h-9 sm:px-3 sm:text-sm"
          >
            Open inbox
          </Link>
        }
        ...
        <div className="flex flex-wrap items-center gap-3 rounded-xl border border-border-subtle bg-hero-bg/60 px-4 py-3.5">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex min-h-8 items-center gap-1.5 rounded-lg border border-border-subtle px-2.5 text-xs font-semibold text-foreground hover:bg-primary-light/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 disabled:cursor-not-allowed disabled:opacity-50 sm:min-h-9 sm:px-3 sm:text-sm"
            >
