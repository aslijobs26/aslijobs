...
export const interviewsToolbarControlClassName =
  "h-9 w-full rounded-lg border border-border-subtle bg-surface px-3 text-sm text-foreground shadow-sm transition-[border-color,box-shadow] hover:border-primary/25 hover:shadow-md focus-visible:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/30";
