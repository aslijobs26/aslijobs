...
import {
  ...
  EMPLOYER_DASHBOARD_PROFILE_MENU_MY_PROFILE,
  EMPLOYER_DASHBOARD_PROFILE_MENU_SETTINGS,
  ...
  return (
    <div ref={rootRef} className={cn("relative", className)}>
      ...
      >
        ...
        >
          <UserRound className="size-4 shrink-0 text-muted" strokeWidth={2} aria-hidden="true" />
          {EMPLOYER_DASHBOARD_PROFILE_MENU_MY_PROFILE}
        </button>
        ...
        <button
          ...
          onClick={() => setIsOpen(false)}
        >
          <Settings className="size-4 shrink-0 text-muted" strokeWidth={2} aria-hidden="true" />
          {EMPLOYER_DASHBOARD_PROFILE_MENU_SETTINGS}
        </button>
