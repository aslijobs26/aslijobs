...
import operationsAnalyticsRouter from "./analytics/operations-analytics.routes.js";
...
operationsRouter.use("/analytics", operationsAnalyticsRouter);
...
operationsRouter.use("/placements", operationsPlacementsRouter);
